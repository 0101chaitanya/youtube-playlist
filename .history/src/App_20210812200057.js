  ...
  return (
    <div className="flex flex-col flex-1 w-screen App">
      ...
      <div className="flex flex-wrap sm:flex-col md:flex-row ">
        ...
        <div className="flex flex-wrap flex-1 border-4 max-w-screen sm:flex-col sm:items-center md:justify-between md:flex-row">
          <Comments className="flex-1 md:w-3/5 md:max-w-md" />
          <VideoSuggestions className="flex-1 md:w-2/5 md:max-w-md" />
        </div>
      </div>
    </div>
  );
