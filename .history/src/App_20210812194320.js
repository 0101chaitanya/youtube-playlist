  ...
  return (
    <div className="flex flex-col flex-1 w-screen App">
      ...
      <div className="flex flex-wrap sm:flex-col md:flex-row ">
        ...
        <div className="flex flex-wrap flex-1 w-full border-4 border-red-800 sm:flex-col md:flex-row">
          <Comments className="flex-1 md:w-1/2" />
          <VideoSuggestions className="flex-1 md:w-1/2" />
        </div>
      </div>
    </div>
  );
