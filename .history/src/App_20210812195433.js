  ...
  return (
    <div className="flex flex-col flex-1 w-screen App">
      ...
      <div className="flex flex-wrap sm:flex-col md:flex-row ">
        ...
        <div className="flex flex-wrap flex-1 border-4 border-red-800 max-w-screen sm:flex-col md:flex-row">
          <Comments className="flex-1 md:w-1/2 md:max-w-md" />
          <VideoSuggestions className="flex-1 md:w-1/2 md:max-w-screen-md" />
        </div>
      </div>
    </div>
  );
